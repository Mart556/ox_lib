...
const ListItem = forwardRef<Array<HTMLDivElement | null>, Props>(({ item, index, scrollIndex, checked }, ref) => {
  ...
  return (
    ...
    >
      <Group spacing={0} noWrap className={classes.buttonWrapper} style={{ flex: 1 }}>
        {item.icon && (
        ...
        {Array.isArray(item.values) ? (
          <Group position="apart" w="100%" style={{ flex: 1, minWidth: 0 }}>
            <Stack spacing={0} justify="space-between" style={{ flex: 1, minWidth: 0 }}>
