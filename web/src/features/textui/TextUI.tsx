...
const useStyles = createStyles((theme, params: { position?: TextUiPosition }) => ({
  ...
  container: {
    ...
    background:
      'radial-gradient(140.75% 140.75% at 50% 50%, rgba(26, 27, 30, 0.97) 0%, rgba(8, 8, 9, 0.87) 100%), linear-gradient(156deg, rgba(255, 255, 255, 0.00) 38.82%, rgba(255, 255, 255, 0.10) 131.78%)',
    color: '#FFF',
    fontFamily: 'Inter',
    fontSize: 14,
    fontWeight: 500,
